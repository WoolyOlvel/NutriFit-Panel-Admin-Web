...
<head>
    ...
    <meta charset="utf-8" />
    <title>Recuperar Contraseña | NutriFit Planner</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Reset Password NutriFit Planner" name="description" />
    <meta content="Reset NutriFit" name="ASCRIB" />
    <!-- App favicon -->
                            ...
                            <div class="row justify-content-center g-0">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <p class="text-muted">Recupere Su Contraseña Con NutriFit Planner</p>
                                        ...
                                        <div class="p-2">
                                            <form>
                                                ...
                                                <div class="text-center mt-4">
                                                    <button class="btn btn-success w-100" type="submit">Enviar Enlace De Restablecimiento</button>
                                                </div>
                                            </form><!-- end form -->
                                        </div>

                                        <div class="mt-5 text-center">
                                            <p class="mb-0">Espera, Recuerdo Mi Contraseña... <a href="../login/login.php" class="fw-semibold text-primary text-decoration-underline"> Regresar </a> </p>
                                        </div>
                                    </div>
                                </div>
                                <!-- end col -->
