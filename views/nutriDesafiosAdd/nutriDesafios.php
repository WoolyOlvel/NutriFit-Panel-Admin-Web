...
<head>
    ...
    <meta charset="utf-8" />
    <title>Geo|Green - Empresas</title>
...
<body>
                    ...
                    <div class="modal-body">
                        <div class="mt-2 text-center">
                            ...
                            <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                                <h4>¿Está Seguro De Eliminar Este NutriDesafio?</h4>
                                <p class="text-muted mx-4 mb-0">No Podrá Recuperar El NutriDesafio</p>
                            </div>
                        </div>
                        <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                            <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">Cerrar</button>
                            <button type="button" class="btn w-sm btn-danger" id="delete-notification">Sí, Eliminar NutriDesafio!</button>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">NutriDesafios</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="./nutriDesafios.php">Menu</a></li>
                                        <li class="breadcrumb-item active">NutriDesafios</li>
                                    </ol>
                                </div>
                                ...
                                <div class="row g-2">
                                    <div class="col-lg-auto">
                                        <div class="hstack gap-2">
                                            ...
                                            <!-- <button type="button" id="btnNuevo" data-bs-toggle="modal" data-bs-target="#modalCategoria" class="btn btn-success btn-label waves-effect waves-light"><i class="ri-add-line align-bottom me-1 label-icon align-middle fs-16 me-2"></i> <strong>Añadir Empresa</strong></button> -->
                                            ...
                                            <button type="button" id="btnNuevo" data-bs-toggle="modal" data-bs-target="#modalCategoria" class="btn btn-success btn-label waves-effect waves-light">
                                                    ...
                                                    <strong style="margin-left: 0.5rem;">Añadir NutriDesafio</strong>
                                            </button>
    ...
    <script type="text/javascript" src="nutriDesafio.js"></script>
