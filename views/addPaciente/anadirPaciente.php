                    ...
                    <div class="modal-body">
                        <div class="mt-2 text-center">
                            ...
                            <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                                <h4>¿Está Seguro De Eliminar Este Paciente?</h4>
                                <p class="text-muted mx-4 mb-0">No Podrá Recuperar El Paciente</p>
                            </div>
                        </div>
                        <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                            <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">Cerrar</button>
                            <button type="button" class="btn w-sm btn-danger" id="delete-notification">Sí, Eliminar Paciente!</button>
                        </div>
                    </div>
                        ...
                        <div class="card" id="ticketsList">
                            <div class="card-header border-0">
                                <div class="d-flex align-items-center">
                                    <h5 class="card-title mb-0 flex-grow-1"><strong>Añade Pacientes Nuevos</strong></h5>
                                    <div class="flex-shrink-0">
                                        <div class="d-flex flex-wrap gap-2">
                                            <!-- <button id="btnNuevo" class="btn btn-danger add-btn" data-bs-toggle="modal" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> Añadir Cliente</button>
                                            <button class="btn btn-soft-secondary" id="remove-actions" onClick="deleteMultiple()"><i class="ri-delete-bin-2-line"></i></button> -->
                                        
                                            <button type="button" id="btnNuevo" data-bs-toggle="modal" data-bs-target="#showModal" class="btn btn-success btn-label waves-effect waves-light">
                                                    ...
                                                    <strong style="margin-left: 0.5rem;">Añadir Paciente</strong>
                                            </button>
                            ...
                            <div class="card-body">
                                <div class="table-responsive table-card mb-4">
                                    <table class="table align-middle table-nowrap mb-0"  style="width:100%" id="ticketTable">
                                        <thead>
                                            <tr>
