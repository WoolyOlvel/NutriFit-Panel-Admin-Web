...
<head>
    ...
    <meta charset="utf-8" />
    <title>Composición Corporal | NutriFit Planner</title>
                    ...
                    <div class="modal-body">
                        <div class="mt-2 text-center">
                            ...
                            <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                                <h4>¿Está Seguro De Eliminar Esta Composición Corporal?</h4>
                                <p class="text-muted mx-4 mb-0">No Podrá Recuperar La Composición Corporal</p>
                            </div>
                        </div>
                        <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                            <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">Cerrar</button>
                            <button type="button" class="btn w-sm btn-danger" id="delete-notification">Sí, Eliminar Composición Corporal!</button>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Utilidades - Composición Corporal</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="../composicionCorporal/composicionCorporal.php">Menu</a></li>
                                        <li class="breadcrumb-item active">Composición Corporal</li>
                                    </ol>
                                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <h5 class="card-title mb-0">Composición Corporal</h5>
                                    ...
                                    <div class="col-lg-auto">
                                        ...
                                        <div class="hstack gap-2">
                                            ...
                                            <button type="button" id="btnNuevo" data-bs-toggle="modal" data-bs-target="#modalCategoria" class="btn btn-success btn-label waves-effect waves-light">
                                                ...
                                                <strong style="margin-left: 0.5rem;">Añadir Composición Corporal</strong>
                                            </button>
