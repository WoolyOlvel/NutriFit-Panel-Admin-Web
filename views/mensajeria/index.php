<?php 
// Coloca esto al principio de chat.php (dentro de views/chat/)
$current_path = $_SERVER['REQUEST_URI']; 
$path_parts = explode('/', trim($current_path, '/')); 
$levels_up = count($path_parts) - 2; 
$base_path = str_repeat('../../', $levels_up);
?>
<!doctype html>
...
<head>
    ...
    <!-- glightbox css -->
    <link rel="stylesheet" href="<?php echo $base_pathl; ?>assets/libs/glightbox/css/glightbox.min.css">
    ...
    <script src="<?php echo $base_pathl; ?>assets/js/choices.min.js"></script>
    <script src="<?php echo $base_pathl; ?>assets/js/flatpickr.min.js"></script>
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    <div class="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n6 p-3">
   ...
   <!-- glightbox js -->
    <script src="<?php echo $base_pathl; ?>assets/libs/glightbox/js/glightbox.min.js"></script>

    <!-- fgEmojiPicker js -->
    <script src="<?php echo $base_pathl; ?>assets/libs/fg-emoji-picker/fgEmojiPicker.js"></script>

    <!-- chat init js -->
    <script src="<?php echo $base_pathl; ?>assets/js/pages/chat.init.js"></script>
