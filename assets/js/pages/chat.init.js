...
!(function () {
  ...
  function u(e, t, s, n, a) {
    ...
    if (null != t)
      ...
      for (r += '<div class="message-img mb-0">', i = 0; i < s.length; i++)
        r +=
          ...
          s[i] +
          '" download=""><i class="ri-download-2-line me-2 text-muted align-bottom"></i>Descargar</a>                            <a class="dropdown-item" href="#"><i class="ri-reply-line me-2 text-muted align-bottom"></i>Responder</a>                                              </div>                    </li>                </ul>                </div>            </div>';
      r += "</div>";
    } else
      0 < n.length &&
        (r +=
    ...
    return (
      !0 === a &&
        (r +=
          '<div class="dropdown align-self-start message-box-drop">                <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                    <i class="ri-more-2-fill"></i>                </a>                <div class="dropdown-menu">                    <a class="dropdown-item reply-message" href="#"><i class="ri-reply-line me-2 text-muted align-bottom"></i>Responder</a>                                    <a class="dropdown-item copy-message" href="#"><i class="ri-file-copy-line me-2 text-muted align-bottom"></i>Copiar</a>                                       </div>            </div>'),
      (r += "</div>")
    );
  }
  function p() {
